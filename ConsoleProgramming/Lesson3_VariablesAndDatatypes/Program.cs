...
fullName = Console.ReadLine().ToUpperInvariant().ToLower();
...
Console.WriteLine($"Hi {char.ToUpper(fullName[0]) + fullName.Substring(1)}, we have collected the following info based on your input:" +
    $"\nYou're age is => {age}," +
...
//Console.WriteLine("The current UI culture is {0} -> {1}\n", uiCulture2.Name, uiCulture2.DisplayName);